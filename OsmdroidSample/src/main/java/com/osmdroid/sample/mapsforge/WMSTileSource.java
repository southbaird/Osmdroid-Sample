package com.osmdroid.sample.mapsforge;
...
public class WMSTileSource extends OnlineTileSourceBase {
    ...
    public String wmsTileCoordinates(MapTile value) {
        ...
        try {
            stringBuffer.append(URLEncoder.encode(this.layerName,"utf-8"));
    ...
    BoundingBox tile2boundingBox(final int x, final int y, final int zoom) {
        ...
        if(projectionKind.equals("EPSG:3857")){
            ...
            bb.north = yToWgs84Lat(y, zoom);
            bb.south = yToWgs84Lat(y + 1, zoom);
            bb.west = xToWgs84Lon(x, zoom);
            bb.east = xToWgs84Lon(x + 1, zoom);
        }
     ...
     * @return EPSG longitude value.
     */
    static double xToWgs84Lon(int tileX, int zoom) {
     ...
     * @return EPSG latitude value.
     */
    static double yToWgs84Lat(int tileY, int zoom) {
